    ...
    <main className="bg-white h-screen">
      ...
      <div className="flex rounded-md justify-center my-4 h-[5%]">
        <div className="w-[90%] bg-[#EBF5FF] rounded-lg">
          <button
            type="button"
            className="w-[50%] h-[100%] p-1 text-xl font-bold focus:rounded-lg focus:bg-[#BC09FB] focus:text-white"
          >
            Active
          </button>
          <button
      ...
      <div className="flex flex-col space-y-4 justify-center items-center">
        <div className="bg-[#FFB6B6] bg-opacity-50 w-[90%] rounded-lg p-4 text-black flex items-center justify-between py-4">
          ...
          <button className="bg-[#E498FF] py-2 px-4 rounded-xl">Redeem</button>
        </div>
        <div className="bg-[#FFB6B6] bg-opacity-50 w-[90%] rounded-lg p-4 text-black flex items-center justify-between py-4">
          <Image
            src={starbucks}

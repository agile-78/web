    ...
    <main className="w-screen h-screen bg-[#FFFDE7]">
      ...
      <div className="h-[70%] flex items-center justify-center text-center">
        <div className="flex-col">  
          <Image src={questionmark} alt="Question Marks" className="mr-1 w-auto h-auto mb-1 mt-4" />
          <Image src={recyclebin} alt="Recycle Bin" className="mr-1 w-auto h-auto my-1" />
        </div>
      </div>
    </main>
  );
